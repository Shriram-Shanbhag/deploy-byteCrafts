...
document.getElementById("viewOrdersButton").addEventListener("click", () => {
    fetch("http://localhost:5001/order/fetch-all-orders")
...
function viewOrderDetails(orderId) {
    fetch(`http://localhost:5001/order/fetch-order-details/${orderId}`)
        .then(response => response.json())
        .then(details => {
...
document.getElementById("viewRevenueButton").addEventListener("click", () => {
    fetch("http://localhost:5001/order/daily-revenue")
        .then(response => response.json())
        .then(data => {
